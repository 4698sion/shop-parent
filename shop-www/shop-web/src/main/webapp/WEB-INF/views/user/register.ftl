    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $captchaImage.click(function() {
                $captchaImage.hide().attr("src", "/kaptcha/getKaptchaImage?timestamp=" + new Date().getTime()).fadeIn();
            });
            ...
            $("#sendVerifyCodeBtn").click(function() {
                ...
                $.post("${ctx}/sms/send", {'phone':phone}, function(data) {
        ...
        function downtime() {
            if (waitTime == 0) {
                waitTime = 60;
                $("#sendVerifyCodeBtn").prop("disabled", false);
                $("#sendVerifyCodeBtn").val("获取验证码");
            } else {
                $("#sendVerifyCodeBtn").val(waitTime + "s");
                $("#sendVerifyCodeBtn").prop("disabled", true);
                setTimeout(function() {
                    waitTime--;
                    downtime();
                    ...
                    <form id="registerForm" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="phone" id="phone" class="text" maxlength="200" style="width: 120px;" />
                                    <input type="button" id="sendVerifyCodeBtn" style="width:75px;height:30px;margin-left:10px" value="获取验证码" />
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <span class="requiredField">*</span>手机验证码:
                                </th>
                                <td>
                                    <input type="text" name="phoneVerifyCode" class="text" maxlength="200" />
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
											<span class="fieldSet">
												...
												<img id="captchaImage" style="width:80px;height:30px" class="captchaImage" src="/kaptcha/getKaptchaImage" title="点击更换验证码" />
											</span>
                                </td>
                            </tr>
                            <tr>

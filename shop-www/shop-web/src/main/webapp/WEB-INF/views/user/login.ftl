    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $captchaImage.click(function() {
                $captchaImage.hide()
                        .attr("src", "${ctx}/kaptcha/getKaptchaImage?" + new Date().getTime()).fadeIn();
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label>
                                        &nbsp;&nbsp;<a href="${ctx}/find_password">找回密码</a>
                                    </label>
                                </td>
                            </tr>
                            <tr>

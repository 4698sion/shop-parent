...
<head>
    ...
    <meta name="author" content="${goods.name}" />
    <meta name="copyright" content="${goods.name}" />
    <meta name="keywords" content="${goods.name}" />
    <meta name="description" content="${goods.name}" />
        ...
        <div class="span10">
            ...
            [#if goods.type == 0]
                <dl>
                    <dt>销售价:</dt>
                    <dd>
                        <strong id="price">￥${goods.price}</strong>
                    </dd>
                    <dd>
                        <span>
                            (<em>市场价:</em>
                            <del id="marketPrice">￥${goods.marketPrice}</del>)
                        </span>
                    </dd>
                </dl>
            ...
            <div id="parameter" name="parameter" class="parameter">
                ...
                <table>
                    [#list parameterValues as paramterValue]
                        <tr>
                            <th class="group" colspan="2">${paramterValue.group}</th>
                        </tr>
                        [#list paramterValue.entries as entry ]
                            <tr>
                                <th>${entry.name}</th>
                                <td>${entry.value}</td>
                            </tr>
